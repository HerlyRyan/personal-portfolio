    ...
    <div className={`h-screen md:h-screen w-full relative flex flex-col justify-between md:overflow-hidden transition-colors duration-200 ${
      ...
      <ClickRippleEffect>
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
          <div className="absolute w-[600px] h-[600px] bg-accent-blue/15 blur-[150px] rounded-full animate-orbitBlue" />
          <div className="absolute w-[550px] h-[550px] bg-red-600/10 blur-[160px] rounded-full animate-orbitRed" />
        </div>
