      ...
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs font-sans">
        ...
        >
          <div className="space-y-1">
            ...
            <p
              className={`text-xs font-mono break-all ${isLight ? "text-slate-500" : "text-slate-400"}`}
            >
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button
              ...
              style={{ color: "#ffffff" }} // Memaksa warna putih secara inline agar tidak tertimpa CSS global
              className="px-4 py-2 rounded-xl text-xs font-mono bg-accent-blue hover:bg-accent-blue/90 transition-all cursor-pointer shadow-md"
            >
              Ya, Lanjutkan ↗
            </button>
          </div>
