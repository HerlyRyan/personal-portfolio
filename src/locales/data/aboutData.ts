...
export const aboutId: AboutContent = {
  ...
  biography: [
    "Saya adalah seorang Freelance Developer yang berfokus pada pengembangan aplikasi web berskala enterprise menggunakan Laravel (PHP) serta aplikasi mobile lintas platform dengan Flutter (Dart). Memiliki ketertarikan mendalam pada penulisan kode yang bersih, terstruktur, serta arsitektur yang mudah dirawat.",
...
export const aboutEn = {
  ...
  biography: [
    "I am a Freelance Developer specializing in enterprise web development with Laravel (PHP) and cross-platform mobile applications using Flutter (Dart). I have a deep passion for writing clean, structured code and maintainable software architecture.",
